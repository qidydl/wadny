...
<html>
<head>
<title>Edge IRC Network - 403 error</title>
...
<table border="0" cellspacing="1" cellpadding="2" bgcolor="#606060" width="370"><?php
  ...
  echo "You do not have authorization to access '" . $REQUEST_URI . "'.  The server has been configured to deny access.  Thank you, drive though.\n";
  edgetableclose();
  edgefooter();
?>