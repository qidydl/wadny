...
<tr><td background="images/mainleft.gif"><img src="images/mainleft.gif"></td>
    <td>
      <h1>news <hr width="100%" size="2"></h1>
      <span class="newshead"><b>4/18/00 - zilch</b></span>
      <br>This is a temporary design I've created for pretty much no reason whatsoever.  Dun steal it, beeyotch.
      <hr width="90%" size="1">
      <span class="newshead"><b>4/17/00 - zip</b></span>
      <br>nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing nothing 
