...
<html>
<head>
<title>Edge IRC Network - 401 error</title>
...
<table border="0" cellspacing="1" cellpadding="2" bgcolor="#606060" width="370"><?php
  ...
  echo "You do not have authorization to access '" . $REQUEST_URI . "'.  Please make sure you have a valid login.  Thank you, drive though.\n";
  edgetableclose();
  edgefooter();
?>